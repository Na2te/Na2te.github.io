...
![기존 코드](/assets/img/study/android/Local%20Properties를%20이용하여%20서버%20IP%20등%20민감%20정보%20숨기기/기존%20코드.png.png){: width="800" loading="lazy"}
안좋은 코드
{:.figcatpion}    
...
## Local Properties
Android Project를 생성하면 보이는 local.propreties는 .gitignore 파일에 들어가 있어, Git의 버전 관리에는 포함이 되지 않는다.
