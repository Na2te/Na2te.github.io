...
+ ### 선언별 차이
  ...
  **다만 사용자가 직접 최근 실행 목록에서 밀어서 닫는 등 명시적인 종료 or 재부팅의 경우에는 복원되지 않는다.**
  ...
  <video width="400" src="/assets/img/study/android/극한의%20상황에서도%20값%20보존하기/최종.mp4" style="display:block; margin-bottom:10px;  margin-left: auto; margin-right: auto;" alt="뚝딱" controls></video>Recomposition, Configuration Change, Process Kill마다 값
  {:.figcaption}
