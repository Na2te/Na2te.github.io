...
|크기 보통|크기 최대|    
|:--:|:--:|    
|![글자 변경 X Before](../../../assets/img/study/android/2_글자_안바뀜_before.jpg){: lazy width="300"}|![글자 변경 X After](../../../assets/img/study/android/2_글자_안바뀜_after.jpg){: lazy width="300"}|    
|![글자 변경 X Before](../../../assets/img/study/android/2_글자_바뀜_before.jpg){: lazy width="300"}|![글자 변경 X After](../../../assets/img/study/android/2_글자_바뀜_after.jpg){: lazy width="300"}|    
