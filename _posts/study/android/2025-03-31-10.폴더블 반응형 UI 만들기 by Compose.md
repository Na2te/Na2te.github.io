...
[XML로 폴더블 반응형 UI 만들기]("https://hangeulmansae.github.io/study/android/2025-03-24-8.%ED%8F%B4%EB%8D%94%EB%B8%94-%EB%B0%98%EC%9D%91%ED%98%95-UI-%EB%A7%8C%EB%93%A4%EA%B8%B0/")
...
[Jetpack Window Manager](https://developer.android.com/jetpack/androidx/releases/window?hl=ko#kts)를 이용해 폴더블 값을 Flow로 받으면서, 그에 따른 UI 로직 처리를 해주는 것이다.
